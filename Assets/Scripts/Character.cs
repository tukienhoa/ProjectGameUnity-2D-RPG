...
public class Character : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            if (!MyGameManager.Instance.areItemsLoaded)
            {
                ...
                thePS.SetPlayerCurrentHealth(PlayerPrefs.GetInt("CurrentHP"));
                thePS.SetPlayerCurrentMP(PlayerPrefs.GetInt("CurrentMP"));

                MyGameManager.Instance.areItemsLoaded = true;
            }
        }
